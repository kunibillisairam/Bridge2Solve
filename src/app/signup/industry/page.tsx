...
import { Building2, User, Mail, Lock, Phone, Briefcase, AlertCircle, ArrowRight, ArrowLeft } from 'lucide-react';
...
export default function IndustrySignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!organizationName.trim() || !name.trim() || !organizationType.trim() || !designation.trim()) {
      ...
      <div className="w-full max-w-2xl bg-white p-6 sm:p-10 rounded-lg border border-brandgray-border shadow-standard">
        ...
        <div className="mb-8 pb-6 border-b border-brandgray-border">
          ...
          <p className="text-xs text-brandgray-muted mt-2">
            Register your organization to explore verified community projects, fund solution proposals through CSR, and provide technical mentorship.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-brandgray-border rounded bg-white focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
              >
                <option value="CSR Foundation">CSR Foundation</option>
                <option value="Corporate Enterprise">Corporate Enterprise</option>
                <option value="Tech / Industry Partner">Tech / Industry Partner</option>
                <option value="Incubator / Startup">Incubator / Startup</option>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm border border-brandgray-border rounded focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                  placeholder="e.g. Head of CSR & Social Innovation"
                  required
                />
              </div>
            </div>
